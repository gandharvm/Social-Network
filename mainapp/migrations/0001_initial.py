    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('friend_requests', models.ManyToManyField(to='mainapp.CasualUser')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('admin', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mainapp.PremiumUser')),
            ],
        ),
        migrations.CreateModel(
            name='Friendship',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('Content', models.CharField(max_length=500)),
                ('admin', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='page', to='mainapp.CommercialUser')),
            ],
        ),
    ]
