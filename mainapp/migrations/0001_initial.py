...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='casualuser',
            name='pot_friends',
            field=models.ManyToManyField(related_name='_casualuser_pot_friends_+', to='mainapp.CasualUser'),
        ),
        migrations.CreateModel(
            name='CommercialUser',
            fields=[
        ...
        migrations.AddField(
            ...
            name='user',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='user', to='mainapp.PremiumUser'),
        ),
        migrations.CreateModel(
            name='Friendship',
            fields=[
