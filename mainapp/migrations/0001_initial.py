# Generated by Django 2.2.4 on 2019-10-29 09:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('messages', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='message_on', to='mainapp.GroupMessage')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='from_user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='from_message', to='mainapp.PremiumUser'),
        ),
        migrations.AddField(
